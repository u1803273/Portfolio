...
public class Explorer implements IRobotController {
    ...
    public void exploreControl(){
      ...
      if (exits ==1){
        ...
        // We haven't been here before, so update robotData
    ...
    public void backtrackControl(){
      ...
      if (exits==1){
        ...
        if (exits(IRobot.PASSAGE)>0){
          ...
          int initialHeading = robotData.searchJunction(robot.getLocation().x, robot.getLocation().y);
